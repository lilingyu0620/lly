...
@implementation FMMySelfShareCell
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [self.iconImageView setImage:[UIImage imageNamed:@"myself_share.png"]];
...
{
    static NSString *cellID = @"FMMySelfShareCell";
    return cellID;
}
