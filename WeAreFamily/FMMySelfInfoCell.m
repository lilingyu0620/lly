...
@implementation FMMySelfInfoCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.iconImageView = [[UIImageView alloc] initWithFrame:CGRectMake(10, 15, 66, 66)];
        self.iconImageView.clipsToBounds = YES;
        self.iconImageView.contentMode = UIViewContentModeScaleAspectFill;
        self.iconImageView.layer.cornerRadius = self.iconImageView.frame.size.width * 0.5;
        [self.iconImageView setImage:[UIImage imageNamed:@"myself_Head_Default.png"]];
        [self.contentView addSubview:self.iconImageView];
        
        self.nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(80, 25, SCREEN_WIDTH - 120.0, 25)];
        self.nameLabel.textColor = RGBEQ(51.0);
        self.nameLabel.font = [UIFont systemFontOfSize:16.0];
        [self.nameLabel setBackgroundColor:[UIColor clearColor]];
        [self.nameLabel setText:@"李凌宇"];
        self.nameLabel.numberOfLines = 1;
        [self.contentView addSubview:self.nameLabel];
        
        
        self.numberLabel = [[UILabel alloc]initWithFrame:CGRectMake(80, 50, SCREEN_WIDTH-120.0, 25)];
        self.numberLabel.textColor = RGBEQ(51.0);
        self.numberLabel.font = [UIFont systemFontOfSize:12.0];
        self.numberLabel.backgroundColor = [UIColor clearColor];
        [self.numberLabel setText:[NSString stringWithFormat:@"伐木累号:%@",@"1234567890"]];
...
{
    static NSString *cellID = @"FMMySelfInfoCell";
    return cellID;
}
...
{
//    [self.iconImageView setGameImageWithURLString:entity.gameIcon placeholderImage:nil completion:nil];
//    [self.nameLabel setText:entity.gameName];
}
